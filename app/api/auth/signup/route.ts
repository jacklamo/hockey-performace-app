...
export async function POST(request: NextRequest) {
  try {
    ...
    // TEMPORARY: Bypass database for development
    ...
    try {
      ...
      console.warn("Database not available, returning mock user:", error)
      return NextResponse.json(
        {
          message: "User created successfully (database unavailable - data not persisted)",
          user: {
            id: 'dev-user-id',
            email,
            name,
